...
<body>
    ...
    <div class="index-container">
        ...
        <div class="index-box" onclick="document.location.href='중급.php'" style="background-color:#BCE9C6">중급</div>
        <div class="index-box" onclick="document.location.href='고급.php'">고급</div>
    </div>
    <div class="container">
